...
const Notes = () => {
    ...
    const [currentNote, setCurrentNote] = useState({ etitle: '', edescription: '', etag: '' })
    ...
    const updateNote = (newNote) => {
        ref.current.click()
        setCurrentNote({ etitle: newNote.title, edescription: newNote.description, etag: newNote.tag })
    }
